...
> We could specify any genes in the data to plot. These genes were the 8 genes with the highest counts summed across all samples, obtained using the command below.  
>allinfo %>%  
