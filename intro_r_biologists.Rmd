...
5. Use pivot_longer to create a ‘tidy’ data set from the following:
dat <-  tibble(sample = 1:10,
             experiment_1 = rnorm(10),
             experiment_2 = rnorm(10))
6. What do you think the `left_join`, `right_join` and `inner_join` functions do?
...
5. `pivot_longer(dat, cols=c(experiment_1, experiment_2), names_to=variables, values_to="counts")`
6. 
</div>
